...
public class safeplaces extends FragmentActivity implements
        OnMapReadyCallback,
   ...
   public void onClick(View v) {
        ...
        String hospital ="hospital",school ="school",temple ="temple";
           ...
           switch (v.getId()) {
               case R.id.search_loc:
                   ...
                   if (!TextUtils.isEmpty(address)) {
                       ...
                       Toast.makeText(this, "please search any location", Toast.LENGTH_SHORT).show();
                   }
                   break;
               ...
               case R.id.temple:
                   mMap.clear();
                   Url = getUrl(latitude, longtitude, temple);
                   transferData[0] =mMap;
                   transferData[1] = Url;

                   getNearbyPlacesData.execute(transferData);
                   Toast.makeText(this,"Searching for nearby Temples",Toast.LENGTH_SHORT).show();
                   Toast.makeText(this,"Showing for nearby Templess",Toast.LENGTH_SHORT).show();
    ...
    private String getUrl(double latitude,double longtitude,String nearbyplace)
    {
        ...
        googleURL.append("&key="+"AIzaSyAXbvAVkJjGwOIfmPtrZLbbj4GVZt8HY-k");

        Log.d("safeplaces","url = "+googleURL.toString());
